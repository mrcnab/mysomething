...
<SCRIPT language="JavaScript">    	
	function OnSubmitForm()
    {
      ...
      {		  
		...
		document.uploadAdvert.action ="upload-add.php";		
 	 }
      else
      if(document.pressed == 'Preview')
      {	  
     	
		 document.uploadAdvert.action ="ad-preview.php";		
...
<div class="hor-line1"></div>
    ...
    <h2>Describe what's in your shop</h2>
     <? } ?>   
          <?=$msg?>            
			  <form name="uploadAdvert" id="uploadAdvert" method="post"  onSubmit="return OnSubmitForm();" enctype="multipart/form-data">
