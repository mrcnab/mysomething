...
if(isset($_REQUEST['txtcanImageCode']) && trim($_REQUEST['txtcanImageCode']) == "")
	{
		...
		if($_POST['txtsecurityCode'] ==  $_POST['txtcanImageCode']){
			...
			$headAboutUs 		= 	$_POST['headAboutUs'];	
			
			
			$fullName			=   $_POST['firstName'] . "  " . $_POST['middleName']."  " . $_POST['lastName'];
			$completeAddress    =  	 $_POST['streetNumber'] . "  " . $_POST['streetName']."  " . $_POST['postalCode'];								
			$phoneNumbers		=  $_POST['phone'] . "  " . $_POST['mobile'];  

			$fullNameforSession	=   $_POST['firstName'] . "  " . $_POST['lastName'];
