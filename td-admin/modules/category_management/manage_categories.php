<?
	...
	$page = "index.php?module_name=category_management&amp;file_name=manage_categories&amp;tab=category";
	...
	$q = "SELECT * FROM title_dev_categories where category_type = 0  order by sort_order asc";
	$q1 = "SELECT count( * ) as total FROM title_dev_categories where category_type = 0  order by sort_order asc";
	
	$get_all_categories_pages = $pg_obj -> getPaging( $q, RECORDS_PER_PAGE, $pageno );
	$get_all_categories = $category_obj -> display_category_listing( $get_all_categories_pages, $page, $pageno );
...
?>
<h1>Manage Classified Categories</h1>
...
<tr>
    <td style="padding-right:0px;" class="td-cls" align="right"><a href="index.php?module_name=category_management&amp;file_name=add_category&amp;tab=category">Add/Edit Classified Category</a></td>
</tr>
</table>
...
<tr class="header">
    <td class="Sr">Sr.</td>
    <td align="left">Classified Category Name</td>
