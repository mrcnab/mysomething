<?
	...
	$page_link = "index.php?module_name=advert_management&file_name=manage_adverts&tab=adverts";
	...
	$q = "SELECT * FROM title_dev_adverts WHERE  AdType = 'Directory' AND advertReferenceNumber = ".$advertReferenceNumber." order by  advertId desc";
	$q1 = "SELECT count( * ) as total FROM title_dev_adverts WHERE  AdType = 'Directory' AND advertReferenceNumber = ".$advertReferenceNumber." order by  advertId desc";
	
	}else if($flag == 'test'){

	$q = "SELECT * FROM title_dev_adverts WHERE  AdType = 'Directory' order by  advertId desc";
	$q1 = "SELECT count( * ) as total FROM title_dev_adverts WHERE  AdType = 'Directory' order by  advertId desc";
	}	
...
?>
<h1>Retailers Shops Management</h1>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="advrt-detail-tbl">
  ...
  <tr>
    <td width="160px;"><strong>Shop Title:</strong></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td colspan="3"><?=$get_single_advert['advertDescirption']?></td>
       ...
       <tr>
    <td><strong>Shop Images:</strong></td>
    <td colspan="3">
     <?  if($getAdvertImages){
